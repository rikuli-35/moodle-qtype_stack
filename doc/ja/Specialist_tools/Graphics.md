...
プロットやグラフィックスは、問題テキスト、模範解答、フィードバックなど、あらゆる[CASテキスト](../Authoring/CASText.md)フィールドに配置できる。
...
* `draw` パッケージは現在サポートされていない。
* バージョン4.0以降では、`{#...#}` タグによってサードパーティのスクリプトと連携する機能が提供されている。この機能の使用例をお持ちの方は、開発者まで連絡してほしい。
