# 問題作成クイック・スタート・ガイド 9: 問題のインポートと小テスト

[1 - 動作する最小限の問題](Authoring_quick_start_1.md) | [2 - 問題変数](Authoring_quick_start_2.md) | [3 - フィードバックを改善する](Authoring_quick_start_3.md) | [4 - ランダム化](Authoring_quick_start_4.md) | [5 - 問題のテスト](Authoring_quick_start_5.md) | [6 - STACK question libraryについて](Authoring_quick_start_6.md) | [7 - 複数回答欄問題](Authoring_quick_start_7.md) | [8 - 数式簡略の無効化](Authoring_quick_start_8.md) | [9 - 問題のインポートと小テスト]
...
3. `ユーザーを追加/削除`し,このグループの特定の学生のIDをクリックし,追加をクリックしてグループに入れます。このグループに入れる必要のある学生全員に対してこの操作繰り返します。
...
- [より多くの入力タイプについて学ぶ](../../en/Authoring/Inputs/index.md),
- [より多くの解答テストについて学ぶ](../../en/Authoring/Answer_Tests/index.md),
- [CASTextフィールド](../Authoring/CASText.md)に[プロット](../../en/CAS/Maxima_plot.md)  を追加する
- [複数言語のサポートを追加する](../Authoring/Languages.md),
- [同値変形の使用について学ぶ](../Specialist_tools/Equivalence_reasoning/index.md),
